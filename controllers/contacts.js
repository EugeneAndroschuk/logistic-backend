...
const findCity = async (req, res, next) => {
  try {
    ...
    const options = {
      hostname: "api.lardi-trans.com",
      path: "/v2/references/towns/by/name?language=uk&query=kiev&limit=5",
      method: "GET",
      headers: {
...
const updateFavorite = async (req, res, next) => {
  try {
    const { error } = contactsJoiSchemas.updateFavoriteSchema.validate(
      req.body
    );
